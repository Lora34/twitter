...
class Twitter {
    constructor({ listElem, modalElems }) {
        ...
        this.elements.modal.forEach(this.handlerModul, this)
    }

    renderPosts(posts) {
        this.elements.listElem.textContent = ''; //Удаляем существующие элементы, textContent работает быстрее
    ...
    handlerModul({button, modal, overlay, close}) {
